...
parse_player_move<- function(player, move, pieces){
  ...
  if(piece=="queen"){
    if(player=="White"){
      pieces[["white_queen"]][pieces[["white_queen"]]["no"]==no,]["Var1"]<-location[1]
      pieces[["white_queen"]][pieces[["white_queen"]]["no"]==no,]["Var2"]<-location[2] |> as.numeric()
    }
    
    if(player=="Black"){
      pieces[["black_queen"]][pieces[["black_queen"]]["no"]==no,]["Var1"]<-location[1]
      pieces[["black_queen"]][pieces[["black_queen"]]["no"]==no,]["Var2"]<-location[2] |> as.numeric()
    }
  }
  
  if(piece=="king"){
    if(player=="White"){
      pieces[["white_king"]][pieces[["white_king"]]["no"]==no,]["Var1"]<-location[1]
      pieces[["white_king"]][pieces[["white_king"]]["no"]==no,]["Var2"]<-location[2] |> as.numeric()
    }
    
    if(player=="Black"){
      pieces[["black_king"]][pieces[["black_king"]]["no"]==no,]["Var1"]<-location[1]
      pieces[["black_king"]][pieces[["black_king"]]["no"]==no,]["Var2"]<-location[2] |> as.numeric()
    }
  }
